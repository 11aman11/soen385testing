...
public class ExampleTest {
    ...
    @Test
    public void testFunctionA_ZeroY() {
        Example example = new Example(7, 2);
        int result = example.Function_A(0);
        assertEquals(-7, result); // y - a = 0 - 7 = -7
    }
    ...
    @Test
    public void testFunctionB_XGreaterThan6() {
        Example example = new Example(7, 2);
    ...
    @Test
    public void testFunctionB_XEqualTo6() {
        Example example = new Example(7, 2);
        int result = example.Function_B(6);
        assertEquals(4, result); // x - b = 6 - 2 = 4
    }
